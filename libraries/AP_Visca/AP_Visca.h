...
class AP_Visca
{
	public:
		AP_Visca()
		{
			change_ozoom=change_dzoom=change_focus=change_shutter=change_iris=change_exposure=change_aperture=change_ozoom=change_dzoom=change_focus=change_shutter=change_iris=change_exposure=change_aperture=0;
		}
